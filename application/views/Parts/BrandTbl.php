...
<div class="row">
    ...
    <div class="col-3 ">
        ...
        <input type="text" class="form-control" id="txtName2" placeholder="Brand Name" maxlength="20">
    </div>
...
<div class="row">
     <div class="col-3">
        ...
        <textarea class="form-control" id="txtDesc2" placeholder="Brand Description" maxlength="100" rows="3" cols="3"></textarea>
    </div>
     <div class="col-3 ">
