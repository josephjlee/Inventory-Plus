...
<div class="row">
    ...
    <div class="col-3 ">
        ...
        <input type="text" class="form-control" id="txtName2" placeholder="Location Name" maxlength="20">
    </div>
...
<div class="row">
    <div class="col-3">
        ...
        <textarea class="form-control" id="txtDesc2" placeholder="Location Description" maxlength="100" rows="3" cols="3"></textarea>
    </div>
    <div class="col-3 ">
    ...
    $(document).ready(function () {
        ...
        $("#update").click(function () {
            ...
            if ($("#txtName2").val().length <= 0) {
                ...
                $.ajax({
                    url: "<?= base_url('index.php/Locations/Update') ?>",
                    type: "post",
