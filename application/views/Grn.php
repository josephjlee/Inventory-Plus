    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Create GRN(goods received note)</li>
            </ol>
                            ...
                            <div class="col-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3">
                                        ...
                                        <input type="text" value=""  class="form-control" placeholder="Default Seller"  max="5" id="txtCustomer">
                                        <span id="new_customer"><i><a href="#">new seller</a></i></span>
                                    </div>



                                    <div class="col-lg-3">
                                        <input type="text" value="0000<?= $invoiceid[0]->IID; ?>" class="form-control" disabled="" id="txtInvoice">
...
<input type="text" value="" class="form-control" disabled="" id="txtLocations">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div align="right">
                                            ...
                                            <div class="col-lg-4">
                                                <input type="button" value="save" class="btn btn-danger" id="btnSave">
                        ...
                        ?>,
                                    ...
                                    bootbox.prompt("Enter name", function (result) {
                                        ...
                                        bootbox.prompt("Enter Telephone", function (result) {
                                            ...
                                            bootbox.prompt("Enter adress", function (result) {
                                                ...
                                                $.ajax({
                                                    url: "<?= base_url('index.php/Grn/CustomerAdd') ?>",
                                                    type: "post",
                                ...
                                $(document).on('click', '#btnadd', function () {
                                    if ($("#qty").val().length <= 0 | txtID.length <= 0) {
                                        ...
                                        $.ajax({
                                            url: "<?= base_url('index.php/Grn/getPrice') ?>",
                                            type: "post",
                                            data: {id: txtID},
                                            success: function (response) {
                                                // you will get response from your php page (what you echo or print)    
                        ...
                        ?>,
                                ...
                                $(document).on('click', '#btnSave', function () {
                                    ...
                                    if (payment < tot) {
                                        ...
                                        if ($('#txtCustomer').val().length <= 0) {
                                            alert("Please select a seller for make Credit");
                                ...
                                function save() {
                                    ...
                                    $.ajax({
                                        type: "POST",
                                        url: "<?= base_url('index.php/Grn/SaveTable') ?>",
...
//
                                ...
                                $("#table-hover").on("click", "td", function () {
                                    ...
                                    $.ajax({
                                        url: "<?= base_url('index.php/Grn/getInfo') ?>",
                                        type: "post",
                                        data: {id: location},
                                        success: function (response) {
                                            // you will get response from your php page (what you echo or print)                 
