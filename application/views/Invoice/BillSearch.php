    ...
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Invoice Search</li>
            </ol>
                        ...
                        <form>
                            <div class="form-group">
                                ...
                                <div class="col-12">
                                    ...
                                    <?php
                                    echo '<table id="tbles" class="display dataTable no-footer" style="width:100%">
        <thead>
            <tr>
                <th>Bill No</th>
                <th>Date</th>
            ...
            $(document).ready(function () {
                ...
                $('#tbles').on('click', 'tr', function () {
                      var id = $(this).find("td").eq(0).html();
                        ...
                        $.ajax({
                url: "<?= base_url('index.php/Invoice/search') ?>",
                type: "post",
                data: {id: id},
